            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    <a href="/"
                        ...
                        <span class="fs-5 d-none d-sm-inline">Bragola fit Dashboard</span>
                    </a>
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        ...
                        <li>
                            <a href="#" class="nav-link px-0 align-middle text-white">
                                ...
                                <span class="ms-1 d-none d-sm-inline">Encomendas</span></a>
                        </li>
                        <li>
                            <a href="#" class="nav-link px-0 align-middle text-white">
                                ...
                                </svg><span class="ms-1 d-none d-sm-inline">Livros</span></a>
                        </li>
                        <li>
                            <a href="#" class="nav-link px-0 align-middle text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <li>
                            <a href="#" class="nav-link px-0 align-middle text-white">
                                ...
                                </svg> <span class="ms-1 d-none d-sm-inline">Categorias</span>
                            </a>
                        </li>
                    </ul>
                    <hr>

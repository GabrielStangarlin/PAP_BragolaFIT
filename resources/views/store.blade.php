...
<body>
    ...
    <div class="col">
        ...
        <div class="container d-flex justify-content-end mt-2">
            <form class="d-flex">
                <input class="form-control me-2" type="search" style="width: 200px;" placeholder="Search"
                    aria-label="Search">
    ...
    <footer class="bg-black text-white py-3">
        <div class="container d-flex justify-content-between align-items-center">
            <div class="text-center w-100">
                <p class="mb-0">© 2024 Todos os direitos reservados MuscleMasterss | Site by Gabriel Stangarlin &
                    Mario
                    Figueiredo.</p>
            </div>

            ...
            <div class="d-flex justify-content-between align-items-center w-100">
                ...
                @auth
                    <div class="d-flex justify-content-end align-items-center w-900 mt-3">
                        ...
                        <!-- Carrinho -->
                        <a href="/cart-details"><button class="btn bg-white position-relative" type="button">
                                <i class="bi-cart-fill me-1"></i>
                                Cart
                            </button></a>
                    </div>
    ...
    <div class="container main-container mt-4">
        <div class="row">
            ...
            <div class="col-md-3 sidebar">
                <ul>
                    <li onclick="showContent('perfil')" id="sidebar-perfil">MEU PERFIL</li>
                    <li onclick="showContent('encomendas')" id="sidebar-encomendas">MINHAS ENCOMENDAS</li>
                    <li onclick="showContent('desejos')" id="sidebar-desejos">LISTA DOS FAVORITOS</li>
                </ul>
            </div>
            <!-- Content -->
            <div class="col-md-9 right-column">
                            ...
                            @foreach ($orders as $order)
                                <div class="border rounded mt-4">
                                    ...
                                    @foreach ($order->orderProducts as $item)
                                        ...
                                        @endphp
                                        <p>Produto: {{ $item->products->name }} -
                                            {{ number_format($item->value, 2, ',', '.') }}€ x {{ $item->quantity }}
                                        </p>
                                    @endforeach
                                    <p>Estado:
                                        @if ($order->order_status == 0)
                ...
                <div id="desejos" class="content-section">
                    <div class="card p-4">
                        <h4>Lista de favoritos</h4>
                        <p>Aqui estão os seus produtos pretendidos.</p>
                        @forelse ($products as $product)
